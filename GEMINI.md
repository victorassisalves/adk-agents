...
async def main():
    ...
    await session_service.create_session(
        app_name="auto_content_with_memory", user_id="test_user", session_id="test_session"
    )
    runner = Runner(
        agent=root_agent, app_name="auto_content_with_memory", session_service=session_service
    )
