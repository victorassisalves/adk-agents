...
```yaml
guideline_name: user_content_guideline_ai_agents_en_v1
version: "v1"
language: "EN"
writing_style:
...
<!-- GUIDELINE_START:user_content_guideline_v2 -->
```yaml
guideline_name: user_content_guideline_ai_agents_en_v2
version: "v2"
language: "EN"
writing_style:
    tone: "semi-casual, conversational, explanatory"
...
length:
    default: "800-1200 words"
    notes: "Short intro. Tight sections."
punctuation_preferences:
    use_dash: false
    allow_emojis: true
    other_notes: "Use '...' for soft pauses. Keep titles concise. Use emojis with great moderation."
general_notes: "Platform-agnostic. Content should be useful and actionable. Use some star trek fun references to make text more dynamic and fun to read."
```