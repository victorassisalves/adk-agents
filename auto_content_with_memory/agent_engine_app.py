...
from auto_content_with_memory.agent import root_agent
from auto_content_with_memory.utils.deployment import (
    parse_env_vars,
    print_deployment_success,
    write_deployment_metadata,
)
from auto_content_with_memory.utils.gcs import create_bucket_if_not_exists
from auto_content_with_memory.utils.tracing import CloudTraceLoggingSpanExporter
from auto_content_with_memory.utils.typing import Feedback
...
@click.option(
    "--extra-packages",
    multiple=True,
    default=["./auto_content_with_memory"],
...
def deploy_agent_engine_app(
    ...
    artifacts_bucket_name = f"{project}-agent-portfolio-adk-logs"
